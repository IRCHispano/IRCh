/*
 * IRC-Hispano IRC Daemon, include/handlers.h
 *
...
extern int mo_dbq(struct Client*, struct Client*, int, char*[]);
...
extern int mr_proxy(struct Client*, struct Client*, int, char*[]);
...
extern int ms_db(struct Client*, struct Client*, int, char*[]);
