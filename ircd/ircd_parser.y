...
%token TPRIV_LIST_CHAN TPRIV_WALK_CHAN TPRIV_NETWORK TPRIV_CHANSERV
%token TPRIV_HIDDEN_VIEWER TPRIV_WHOIS_NOTICE TPRIV_HIDE_IDLE
/* and some types... */
%type <num> sizespec
...
privtype: TPRIV_CHAN_LIMIT { $$ = PRIV_CHAN_LIMIT; } |
          ...
          TPRIV_WALK_CHAN { $$ = PRIV_WALK_CHAN; } |
          TPRIV_CHANSERV { $$ = PRIV_CHANSERV; } |
          TPRIV_HIDDEN_VIEWER { $$ = PRIV_HIDDEN_VIEWER; } |
          TPRIV_WHOIS_NOTICE { $$ = PRIV_WHOIS_NOTICE; } |
          TPRIV_HIDE_IDLE { $$ = TPRIV_HIDE_IDLE; };
